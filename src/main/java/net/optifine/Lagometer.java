    ...
    public static void showLagometer(ScaledResolution scaledResolution) {
        if (gameSettings != null) {
            if (gameSettings.ofLagometer || gameSettings.lastServer) {
                ...
                CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor("30", 2, k2 + 1, -8947849);
                CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor("30", 1, k2, -3881788);
                CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor("60", 2, j2 + 1, -8947849);
                CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor("60", 1, j2, -3881788);
                GlStateManager.matrixMode(5889);
                ...
                CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(" " + MemoryMonitor.getAllocationRateMb() + " MB/s", l1, i2, k1);
