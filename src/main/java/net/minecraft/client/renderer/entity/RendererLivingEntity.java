...
import beta.tiredb56.module.impl.list.misc.BetterFPS;
import beta.tiredb56.module.impl.list.visual.Chams;
...
public abstract class   RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[]{entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)})) {
            ...
            try {
                ...
                float f5 = BetterFPS.getInstance().isState() && BetterFPS.getInstance().uglyModels.getValue() ? 0 : entity.prevLimbSwingAmount + (entity.limbSwingAmount - entity.prevLimbSwingAmount) * partialTicks;
                float f6 = BetterFPS.getInstance().isState() && BetterFPS.getInstance().uglyModels.getValue() ? 0 : entity.limbSwing - entity.limbSwingAmount * (1.0F - partialTicks);
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor) {
        ...
        if (flag || flag1) {
            ...
            boolean flag2 = CheatMain.INSTANCE.moduleManager.moduleBy(Chams.class).state && entitylivingbaseIn instanceof EntityPlayer;

            Color chamsColor;
            if (flag2) {
                final Chams chams = CheatMain.INSTANCE.moduleManager.moduleBy(Chams.class);
