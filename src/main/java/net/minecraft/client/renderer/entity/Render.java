...
public abstract class Render<T extends Entity> implements IEntityRenderer
{
    ...
    {
        if (this.canRenderName(entity) && !CheatMain.INSTANCE.moduleManager.findModuleByClass(NameTags.class).isState())
        {
    ...
    {
        return entity.getAlwaysRenderNameTagForRender() && entity.hasCustomName() && !CheatMain.INSTANCE.moduleManager.findModuleByClass(NameTags.class).isState();
    }
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance)
    {
        ...
        if (CheatMain.INSTANCE.moduleManager.findModuleByClass(NameTags.class).isState() || CheatMain.INSTANCE.moduleManager.findModuleByClass(ESP.class).isState()) return;
