        ...
        if (!this.mc.running) {
            ...
            if (i - this.systemTime >= 100L) {
                ...
                if (flag) {
                    ...
                    CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(this.currentlyDisplayedText, (float) ((k - this.mc.fontRendererObj.getStringWidth(this.currentlyDisplayedText)) / 2), (float) (l / 2 - 4 - 16), 16777215);
                    CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(this.message, (float) ((k - this.mc.fontRendererObj.getStringWidth(this.message)) / 2), (float) (l / 2 - 4 + 8), 16777215);
                }
