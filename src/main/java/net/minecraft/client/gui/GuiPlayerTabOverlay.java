    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
        ...
        if (list1 != null) {
            ...
            for (String s3 : list1) {
                ...
                CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(s3, (float) (width / 2 - i2 / 2), (float) k1, -1);
        ...
        for (int k4 = 0; k4 < l3; ++k4) {
            ...
            if (k4 < list.size()) {
                ...
                if (networkplayerinfo1.getGameType() == WorldSettings.GameType.SPECTATOR) {
                    ...
                    CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(s1, (float) j2, (float) k2, -1862270977);
                } else {
                    CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(s1, (float) j2, (float) k2, -1);
                }
        ...
        if (list2 != null) {
            ...
            for (String s4 : list2) {
                ...
                CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(s4, (float) (width / 2 - j5 / 2), (float) k1, -1);
                k1 += this.mc.fontRendererObj.FONT_HEIGHT;
            }
        }
        ...
        if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
            ...
            if (j > 0) {
                ...
                if (f > 3.0F) {
                    ...
                    CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(s, (float) ((p_175247_5_ + p_175247_4_) / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2), (float) p_175247_2_, i1);
                }
            }
        } else {
            String s1 = EnumChatFormatting.YELLOW + "" + i;
            CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(s1, (float) (p_175247_5_ - this.mc.fontRendererObj.getStringWidth(s1)), (float) p_175247_2_, 16777215);
        }
    }
