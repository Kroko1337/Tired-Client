...
public class GuiAchievement extends Gui
{
    ...
    public void updateAchievementWindow()
    {
        if (this.theAchievement != null && this.notificationTime != 0L && Minecraft.getMinecraft().thePlayer != null)
        {
            ...
            {
               CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(this.achievementTitle, i + 30, j + 7, -256);
               CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(this.achievementDescription, i + 30, j + 18, -1);
            }
