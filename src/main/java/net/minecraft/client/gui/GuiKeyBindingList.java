...
public class GuiKeyBindingList extends GuiListExtended
{
    ...
    public class CategoryEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        {
            CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(this.labelText, GuiKeyBindingList.this.mc.currentScreen.width / 2 - this.labelWidth / 2, y + slotHeight - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT - 1, 16777215);
        }
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
        {
           ...
           CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(this.keyDesc, x + 90 - GuiKeyBindingList.this.maxListLabelWidth, y + slotHeight / 2 - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT / 2, 16777215);
