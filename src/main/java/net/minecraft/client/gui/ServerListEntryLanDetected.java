...
public class ServerListEntryLanDetected implements GuiListExtended.IGuiListEntry
{
    ...
    {
       CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(I18n.format("lanServer.title", new Object[0]), x + 32 + 3, y + 1, 16777215);
       CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(this.field_148291_b.getServerMotd(), x + 32 + 3, y + 12, 8421504);

        if (this.mc.gameSettings.hideServerAddress)
        {
           CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(I18n.format("selectServer.hiddenAddress", new Object[0]), x + 32 + 3, y + 12 + 11, 3158064);
        }
        else
        {
           CheatMain.INSTANCE.fontManager.confortaa.drawStringWithColor(this.field_148291_b.getServerIpPort(), x + 32 + 3, y + 12 + 11, 3158064);
        }
    }
