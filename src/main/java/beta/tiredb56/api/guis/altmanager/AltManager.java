package beta.tiredb56.api.guis.altmanager;
...
import beta.tiredb56.api.guis.accountlogin.AccountLoginThread;
...
public class AltManager extends GuiScreen implements IHook {
    ...
    @Override
    public void initGui() {
        CheatMain.INSTANCE.discordRPC.setStage(new String[]{"In AltManager", "lmfao"});
