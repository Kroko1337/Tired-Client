package beta.tiredb56.api.util.font;
...
import beta.tiredb56.module.impl.list.visual.NameProtect;
...
public class CustomFont extends CFont {
    ...
    public float drawString(String textIn, double xI, double yI, int color, boolean shadow) {
        double x = xI;
        double y = yI;
        final NameProtect nameProtect = (NameProtect) CheatMain.INSTANCE.moduleManager.moduleBy(NameProtect.class);
        if (nameProtect != null) {
