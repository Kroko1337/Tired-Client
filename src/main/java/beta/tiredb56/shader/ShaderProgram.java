...
public class ShaderProgram implements IHook {
    ...
    public ShaderProgram(final String vertexName, final String fragmentName) {
        ...
        final String vertexSource = Extension.EXTENSION.getGenerallyProcessor().renderProcessor.readShader(vertexName);
        ...
        final String fragmentSource =  Extension.EXTENSION.getGenerallyProcessor().renderProcessor.readShader(fragmentName);
