package beta.tiredb56.notification.notificationcenter;
...
public class NotificationCenter extends AbstractNotificationCenter {
	...
	public void render(int x, int y) {
		...
		if (over) {
			...
			FHook.fontRenderer2.drawString(CheatMain.INSTANCE.CLIENT_NAME, x + 5, y - 19, -1);
			FHook.fontRenderer3.drawString("current build: " + CheatMain.INSTANCE.VERSION, x + 5, y + 3, -1);
