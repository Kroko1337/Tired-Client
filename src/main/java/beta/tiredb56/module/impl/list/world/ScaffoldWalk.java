package beta.tiredb56.module.impl.list.world;
...
import beta.tiredb56.api.util.StrafeUtil;
...
public class ScaffoldWalk extends Module {
    ...
    public BooleanSetting movementFix = new BooleanSetting("MovementFix", this, true);
...
*/
    ...
    public void onStrafe(EventStrafe e) {
        if (movementFix.getValue()) {
            e.setCancelled(true);
            StrafeUtil.customSilentMoveFlying(e, Rotations.scaffoldYaw);
        }
